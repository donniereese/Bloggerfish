...
if ($name = strstr ($HTTP_USER_AGENT, "MSIE")) {
	print "<link rel=\"stylesheet\" href=\"controlpanel_alt.css\">";
} else if ($name = strstr ($HTTP_USER_AGENT, "Netscape")) {
	print "<link rel=\"stylesheet\" href=\"controlpanel.css\">";
} else {
	print "<link rel=\"stylesheet\" href=\"controlpanel.css\">";
}
...
<div style="position: absolute; left:0px; top: 110px; width:400px; height:40px;">
	<div style="position:absolute; left:0px; top:0px; background:#000000; filter:alpha(opacity=40); -moz-opacity:.40; opacity:.40; height:100%; width: 100%;"></div>
	<div style="position:absolute; left:0px; top:0px; background:#000000; filter:alpha(opacity=40); -moz-opacity:.40; opacity:.40; height:10px; width: 100%;"></div>
	<div style="padding:8px; padding-left:4px; padding-right:4px; position: absolute; top:10px; left:0px; border-bottom: filter:alpha(opacity=90); -moz-opacity:.90; opacity:.90; 0px solid #555566;">
...
?>	
<br>
<div style="position: absolute; right:0px; top: 110px; width:400px; height:40px;">
	<div style="position:absolute; left:0px; top:0px; background:#000000; filter:alpha(opacity=40); -moz-opacity:.40; opacity:.40; height:100%; width: 100%;"></div>
	<div style="position:absolute; left:0px; top:0px; background:#000000; filter:alpha(opacity=40); -moz-opacity:.40; opacity:.40; height:10px; width: 100%;"></div>
	<div style="padding:8px; padding-left:4px; padding-right:4px; position: absolute; top:10px; left:0px; border-bottom: filter:alpha(opacity=90); -moz-opacity:.90; opacity:.90; 0px solid #555566;">
<b style="color:#ccccee;"> Your Page: </b>
...
<?php
$window = new window();
$window->create("Text App", "movelayer", "522", "174", "10", "160", "noresize", "flat:opaque", "");
?>
...
?>
		...
		<td id="side_td">
			<div id="box3u" style="margin-bottom:4px;">
			...
			<div id="box3u" style="height:auto; margin-bottom:4px;">
