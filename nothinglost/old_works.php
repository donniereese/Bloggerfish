...
<table border="0" cellpadding="2" cellspacing="8">
    <tr>
	    <td width="272px" height="320px" background="images/image_back.jpg" valign="middle" align="center"><img src="images/works/<?php print "$list[preview_image]"; ?>" width="268" height="336" alt="" border="0"></td>
		<td valign="top">
