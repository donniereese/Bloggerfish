...
if (!$_POST[user] || !$_POST[pass]) {
	...
	print "<tr>";
	print "<td>";
	print "<form method=post action=customer.php>";
	print "<table>";
...
$logres = mysql_num_rows(mysql_query("select * from customer where user='$user' and pass='$pass'"));
...
if ($logres <= 0) {
	...
	print "<meta http-equiv='refresh' content='1;url=customer.php'>";
	print "Redirecting...";
}
?>
