...
/*usr add*/	$tprncylvl = 127;			# Transparency Level, 0 = clear, 127 = opaque
...
//		$color = imagecolorallocatealpha($this->image, $rgb->red, $rgb->green, $rgb->blue, $this->fgtransparent ? 127 : 0);
		$color = imagecolorallocatealpha($this->image, $rgb->red, $rgb->green, $rgb->blue, $this->tprncylvl);
...
/*user change*/			'tprncylvl'		=> $this->tprncylvl);
