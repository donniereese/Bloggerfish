...
if ($logres <= 0) {
	...
	print "Welcome back, $user! You are now logged in.<br><br><center>If your browser does not 
automatically 
redirect you to the main community site, then please click <a href=index.php>here</a> to continue..</center>";
	print "</div>";
	print "</div>";
