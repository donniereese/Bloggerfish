...
CREATE TABLE outposts (
  ...
  spys int(11) NOT NULL default '0',
  news text NOT NULL,
  UNIQUE KEY id (id)
) TYPE=MyISAM;
# --------------------------------------------------------
...
CREATE TABLE `tribes` (
  ...
  `land` int(11) NOT NULL default '20',
  `homes` int(11) NOT NULL default '125',
  `barracks` int(11) NOT NULL default '20',
  `farms` int(11) NOT NULL default '150',
  `factories` int(11) NOT NULL default '0',
  `people` int(11) NOT NULL default '500',
  `soldiers` int(11) NOT NULL default '100',
  `swords` int(11) NOT NULL default '0',
  `archers` int(11) NOT NULL default '0',
  `goliath` int(11) NOT NULL default '0',
